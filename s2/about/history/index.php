...
$APPLICATION->SetPageProperty("title", "История");
$APPLICATION->SetPageProperty("PAGE_TEXT_UNDER_TITLE", "Наш путь к успеху — это история инноваций, роста и достижений.");
$APPLICATION->SetPageProperty("keywords", "Проминжиниринг, История");
$APPLICATION->SetPageProperty("description", "История компании и путь к успеху");
$APPLICATION->SetTitle("История");
?>

<img src="/local/templates/.default/assets/img/content/history_1.jpg" alt="" class="img-fluid services-img">
...
<img src="/local/templates/.default/assets/img/content/history_2.jpg" alt="" class="img-fluid services-img">
