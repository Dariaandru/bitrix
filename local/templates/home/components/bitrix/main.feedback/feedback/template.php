...
<div class="col-md-12">
    <label class="font-weight-bold" for="email">
        <?=GetMessage("MFT_SUBJECT")?><?if(empty($arParams["REQUIRED_FIELDS"]) || in_array("SUBJECT", $arParams["REQUIRED_FIELDS"])):?><span class="mf-req">*</span><?endif?>
    </label>
    <input type="text" id="subject" name="SUBJECT" class="form-control" placeholder="Enter Subject" value="<?=$arResult["SUBJECT"]?>">
</div>
</div>
	...
	<div class="col-md-12">
		...
		<textarea name="MESSAGE" id="message" cols="30" rows="5" class="form-control" placeholder="Say hello to us" rows="5" cols="40"><?=($arResult["MESSAGE"] ?? '')?></textarea>
	</div>
	</div>
