...
<?
	 ...
	 Asset::getInstance()->addJs("/local/templates/.default/assets/vendor/bootstrap/js/bootstrap.bundle.min.js");
	 Asset::getInstance()->addJs("/local/templates/.default/assets/vendor/aos/aos.js");
