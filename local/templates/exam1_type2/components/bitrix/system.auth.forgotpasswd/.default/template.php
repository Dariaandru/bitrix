        ...
        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
          <div class="card mb-3">
			...
			<?if (!empty($arParams["~AUTH_RESULT"])):?>
              ...
              <form  
                name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" class="row g-3" novalidate
              >
                ...
                <div class="pt-4 pb-2">
                  <p class="small"><?=GetMessage("PREVIEW")?></p>
                </div>
			...
			<?endif?>
                ...
                <div class="col-12">
                  <p class="small mb-0">
                    <b><a href="<?=$arResult["AUTH_AUTH_URL"]?>"><?=GetMessage("AUTH_AUTH")?>
                    </a></b>
                  </p>
                </div>
